			...
			try{
			    ...
			    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/alumnos", "root", "123456");
			   	Statement st = con.createStatement();
			   		...
			   		System.out.println("Antes de actualizar el curso");
				int i = st.executeUpdate("UPDATE cursos SET nombre='"+ nombre +"', descripcion='"+ descripcion +"', fecha_inicio='"+fechaInicio+"', fecha_fin='"+ fechaFin +"', numero_horas="+ numeroHoras +", objetivos='"+ objetivos +"', requisitos='"+ requisitos +"'  WHERE id="+ idCurso +"; ");   
